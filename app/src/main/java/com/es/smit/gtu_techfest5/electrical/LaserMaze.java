...
public class LaserMaze extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("LaserMaze");
        View v=inflater.inflate(R.layout.details_lasermaze,container,false);
