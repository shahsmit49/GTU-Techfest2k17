...
public class Citadel extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("The Citadel");
        View v=inflater.inflate(R.layout.details_thecitadel,container,false);
