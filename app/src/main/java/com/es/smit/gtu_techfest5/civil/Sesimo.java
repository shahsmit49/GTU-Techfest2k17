...
public class Sesimo extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Seismo Significado");
        View v=inflater.inflate(R.layout.details_seismosignificado,container,false);
