...
public class logo_computer extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Logo Design");
        View v=inflater.inflate(R.layout.details_logodesign,container,false);
