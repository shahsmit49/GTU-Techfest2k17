package com.es.smit.gtu_techfest5.mechanical;
...
public class Model_Rocketry extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Model Rocketry");
        View v=inflater.inflate(R.layout.details_modelrocketry,container,false);
