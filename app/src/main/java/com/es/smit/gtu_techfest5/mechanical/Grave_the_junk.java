...
public class Grave_the_junk extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Grave the Junk");
        View v=inflater.inflate(R.layout.details_gravethejunk,container,false);
