...
public class Khajane extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Khajan-E-Khoj");
        View v=inflater.inflate(R.layout.details_khajanekhoj,container,false);
