...
public class Smartmanager extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Smart Manager");
        View v=inflater.inflate(R.layout.details_smartmanager,container,false);
