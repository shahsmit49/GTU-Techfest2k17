...
public class Cad_Combat extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Cad Combat");
        View v=inflater.inflate(R.layout.details_cadcombat,container,false);
