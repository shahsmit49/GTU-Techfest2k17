...
public class Pharmamodels extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Pharma Models");
        View v=inflater.inflate(R.layout.details_pharmamodels,container,false);
