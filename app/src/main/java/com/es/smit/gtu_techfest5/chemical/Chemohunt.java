package com.es.smit.gtu_techfest5.chemical;
...
public class Chemohunt extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Chemo Hunt");
        View v=inflater.inflate(R.layout.details_chemohunt,container,false);
