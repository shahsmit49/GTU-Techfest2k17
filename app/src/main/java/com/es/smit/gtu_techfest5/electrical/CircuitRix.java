package com.es.smit.gtu_techfest5.electrical;
...
public class CircuitRix extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("CircuitRix");
        View v=inflater.inflate(R.layout.details_circuitrix,container,false);
