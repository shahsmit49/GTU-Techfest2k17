...
public class Knock_On extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Knock On");
        View v=inflater.inflate(R.layout.details_knockon,container,false);
