...
public class Myselfmedicine extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Myself Medicine");
        View v=inflater.inflate(R.layout.details_myselfmedicine,container,false);
