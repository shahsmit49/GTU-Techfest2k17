...
public class Arduino extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Arduino");
        View v=inflater.inflate(R.layout.details_arduino,container,false);
