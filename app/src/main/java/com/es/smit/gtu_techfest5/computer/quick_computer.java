...
public class quick_computer extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Quick Page");
        View v=inflater.inflate(R.layout.details_quickpage,container,false);
