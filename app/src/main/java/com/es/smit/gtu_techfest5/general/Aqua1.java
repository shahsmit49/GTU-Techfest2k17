...
public class Aqua1 extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Aqua Arena");
        View v=inflater.inflate(R.layout.details_aquaarena,container,false);
