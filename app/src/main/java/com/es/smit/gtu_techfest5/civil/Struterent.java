package com.es.smit.gtu_techfest5.civil;
...
public class Struterent extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Structurent Magnifica");
        View v=inflater.inflate(R.layout.details_structurent_mangnifica,container,false);
