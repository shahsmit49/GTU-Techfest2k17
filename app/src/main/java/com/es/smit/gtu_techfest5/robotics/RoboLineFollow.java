package com.es.smit.gtu_techfest5.robotics;
...
public class RoboLineFollow extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Robo Line Follow");
        View v=inflater.inflate(R.layout.details_robolinefollow,container,false);
