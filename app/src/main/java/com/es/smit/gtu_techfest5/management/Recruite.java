...
public class Recruite extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Recruit-E-Race");
        View v=inflater.inflate(R.layout.details_recruiterace,container,false);
