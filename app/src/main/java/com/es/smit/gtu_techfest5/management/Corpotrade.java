...
public class Corpotrade extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Corpo Trade");
        View v=inflater.inflate(R.layout.details_corpotrade,container,false);
