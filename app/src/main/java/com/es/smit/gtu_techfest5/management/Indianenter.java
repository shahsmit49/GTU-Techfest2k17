package com.es.smit.gtu_techfest5.management;
...
public class Indianenter extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Indian Entrepreneur");
        View v=inflater.inflate(R.layout.details_indianentrepreneur,container,false);
