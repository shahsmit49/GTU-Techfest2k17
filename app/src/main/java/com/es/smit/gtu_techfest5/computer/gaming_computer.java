...
public class gaming_computer extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Lan-Gaming");
        View v=inflater.inflate(R.layout.details_langaming,container,false);
