...
public class Pralay extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Pralay The Apoalypse");
        View v=inflater.inflate(R.layout.details_pralaytheapocalypse,container,false);
