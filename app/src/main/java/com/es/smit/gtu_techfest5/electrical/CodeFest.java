...
public class CodeFest extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("CodeFest");
        View v=inflater.inflate(R.layout.details_codefest,container,false);
