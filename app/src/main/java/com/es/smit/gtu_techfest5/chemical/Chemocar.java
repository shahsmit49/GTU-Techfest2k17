...
public class Chemocar extends Fragment implements View.OnClickListener
{
    Button b;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state)
    {
        getActivity().setTitle("Chemo Car");
        View v=inflater.inflate(R.layout.details_chemocar,container,false);
