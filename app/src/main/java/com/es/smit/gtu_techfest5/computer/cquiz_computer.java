...
public class cquiz_computer extends Fragment implements View.OnClickListener {
    Button b;

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state) {
        getActivity().setTitle("C-Quiz and Debugging");
        View v = inflater.inflate(R.layout.details_cquiz, container, false);
